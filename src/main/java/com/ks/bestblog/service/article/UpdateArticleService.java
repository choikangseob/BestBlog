...
import com.ks.bestblog.repository.article.UpdateArticleRepository;
...
public class UpdateArticleService {
    ...
    public UpdateArticleResponse updateArticle(UpdateArticleRequest updateArticleRequest, MemberDetails member){
        ...
        Optional<Article> ArticleOptional = updateArticleRepository.findByIdAndCreateMemberId(updateArticleRequest.id(), member.getId());
